import unittest
import scipy
from adjoint_state_method import asm_analytic1D, asm_neural_1D
import numpy as np
import dadi
...
class TridiagonalTestCase(unittest.TestCase):
    ...
    def test_tridiagonal(self):
        ...
        adjointer = asm_neural_1D.AdjointStateMethod(timeline_architecture_initial, timeline_architecture_last, [10],
