"""
change plot_1d_fs to working version
"""
...
def plot_1d_fs(fs, fig_num=None, show=True):
    ...
    fs: 1-dimensional Spectrum_mod.py
    ...
    pylab.semilogy(fs, '-ob', label='1d_fs')
...
def plot_single_2d_sfs(sfs, vmin=None, vmax=None, ax=None,
    ...
    pop_ids: If not None, override pop_ids stored in Spectrum_mod.py.
